...
[![PyPI version](https://badge.fury.io/py/calculator_pkg_ex_jmf.svg)](https://badge.fury.io/py/calculator_pkg_ex_jmf)
![PyPy](https://img.shields.io/badge/PyPy-7.3.17-blue)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/calculator_pkg_ex_jmf)](https://pypi.org/project/calculator_pkg_ex_jmf/)
![Tests](https://github.com/jfuruness/calculator_pkg_ex_jmf/actions/workflows/tests.yml/badge.svg)
...
```python
from calculator_pkg_ex_jmf import FileCalculator
...
```bash
pip3 install calculator_pkg_ex_jmf
```
...
```bash
git clone https://github.com/jfuruness/calculator_pkg_ex_jmf.git
cd calculator_pkg_ex_jmf
pip3 install -e .[test]
pre-commit install
```
...
```
cd calculator_pkg_ex_jmf
pytest calculator_pkg_ex_jmf
ruff check calculator_pkg_ex_jmf
ruff format calculator_pkg_ex_jmf
mypy calculator_pkg_ex_jmf
```
